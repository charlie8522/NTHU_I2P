...
user in an INI file next to IrfanViewPortable.exe called IrfanViewPortable.ini.
...
copy AppNamePortable.ini from this directory to IrfanViewPortable.ini next to
IrfanViewPortable.exe. The options in the INI file are as follows:
